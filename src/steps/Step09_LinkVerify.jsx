...
const CHECKLIST = [
  'All digital product files open correctly',
  'All spreadsheet formulas calculate properly',
  'All PDF pages render and are not blank',
  'Buyer instructions reference correct filenames',
  'ZIP bundle (if applicable) extracts cleanly',
  'Google Sheets link (if applicable) is accessible',
]

export default function Step09_LinkVerify({ appState, onStateChange }) {
  const stepState = appState.steps['9'] || {}
  ...
  function handleComplete() {
    ...
    const newState = {
      ...
      steps: {
        ...appState.steps,
        '9': { ...stepState, inputs: { checked } },
      },
    }
    onStateChange(completeStep(newState, '9', '10'))
  }

  return (
    <div className="p-5 space-y-5">
      <p className="text-sm text-dta-dark/70">
        Verify all product files work correctly before listing. Check every item below.
      </p>
